                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Userid </th><td> {{ $formtransaction->Userid }} </td></tr><tr><th> Transactionnumber </th><td> {{ $formtransaction->Transactionnumber }} </td></tr><tr><th> Total Berat </th><td> {{ $formtransaction->Total_berat }} </td></tr>
                                </tbody>
                            </table>
                        </div>
