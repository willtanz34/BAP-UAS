      ...
      <div class="container ">
        <div class="row">
          <div class="heading_container heading_center">
            <br><br><br><br>
            <h2 class="align-middle text-light">
              Transaksi Saya
            </h2>
          </div>
        </div>
        ...
        <div class="row">
            <?php
     $rows = \DB::select('select created_at, Kurir, Total, productid from form_transactions');
     $products = \DB::select('select Nama, Foto, id from form_products');
     foreach($rows as $row){    
     foreach($products as $product){
        ...
        echo '
          <div class="col-md-12  ">
            <div class="box ">
              <div class="img-box">
                <img src="images/'.$product->Foto.'.jpg" alt="">
              </div>
